...
describe('TransactionBuilder', function() {
  describe('constructs a native payment transaction with one operation', function() {
    ...
    beforeEach(function() {
      ...
      memo = ZionBase.Memo.id('100');

      transaction = new ZionBase.TransactionBuilder(source, { fee: 100 })
        .addOperation(
  ...
  describe('constructs a native payment transaction with custom base fee', function() {
    ...
    beforeEach(function() {
      ...
      transaction = new ZionBase.TransactionBuilder(source, { fee: 1000 })
        .addOperation(
          ZionBase.Operation.payment({
            destination: destination1,
            asset: asset,
  ...
  describe('constructs a native payment transaction with integer timebounds', function() {
    it('should have have timebounds', function(done) {
      ...
      let transaction = new ZionBase.TransactionBuilder(source, {
        timebounds,
        fee: 100
      })
        .addOperation(
  ...
  describe('setTimeout', function() {
    it('not called', function() {
      ...
      let transactionBuilder = new ZionBase.TransactionBuilder(source, {
        fee: 100
      }).addOperation(
        ZionBase.Operation.payment({
          destination:
    ...
    it('sets timebounds', function() {
      ...
      let transaction = new ZionBase.TransactionBuilder(source, { fee: 100 })
        .addOperation(
          ZionBase.Operation.payment({
            destination:
              'GDJJRRMBK4IWLEPJGIE6SXD2LP7REGZODU7WDC3I2D6MR37F4XSHBKX2',
