describe('Asset', function() {
    ...
    describe("constructor", function () {
        ...
        it("throws an error when there's no issuer for non ORC type asset", function () {
            expect(() => new ZionBase.Asset("USD")).to.throw(/Issuer cannot be null/)
        });

        it("throws an error when code is invalid", function () {
            expect(() => new ZionBase.Asset("", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ")).to.throw(/Asset code is invalid/)
            expect(() => new ZionBase.Asset("1234567890123", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ")).to.throw(/Asset code is invalid/)
            expect(() => new ZionBase.Asset("ab_", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ")).to.throw(/Asset code is invalid/)
        });

        it("throws an error when issuer is invalid", function () {
            expect(() => new ZionBase.Asset("USD", "GCEZWKCA5")).to.throw(/Issuer is invalid/)
        });
    });

    describe("getCode()", function () {
        it("returns a code for a native asset object", function () {
            var asset = new ZionBase.Asset.native();
            expect(asset.getCode()).to.be.equal('ORC');
        });

        it("returns a code for a non-native asset", function () {
            var asset = new ZionBase.Asset("USD", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
    ...
    describe("getAssetType()", function () {
        ...
        it("returns credit_alphanum4 if the asset code length is between 1 and 4", function () {
            var asset = new ZionBase.Asset("ABCD", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
        ...
        it("returns credit_alphanum12 if the asset code length is between 5 and 12", function () {
            var asset = new ZionBase.Asset("ABCDEF", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
    ...
    describe("toXDRObject()", function () {
        ...
        it("parses a 3-alphanum asset object", function () {
            ...
            expect(xdr).to.be.instanceof(ZionBase.xdr.Asset);
        ...
        it("parses a 4-alphanum asset object", function () {
            var asset = new ZionBase.Asset("BART", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
            var xdr = asset.toXDRObject();
        ...
        it("parses a 5-alphanum asset object", function () {
            var asset = new ZionBase.Asset("12345", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
            var xdr = asset.toXDRObject();
        ...
        it("parses a 12-alphanum asset object", function () {
            var asset = new ZionBase.Asset("123456789012", "GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ");
            var xdr = asset.toXDRObject();
    ...
    describe("fromOperation()", function () {
      it("parses a native asset XDR", function () {
        var xdr = new ZionBase.xdr.Asset.assetTypeNative();
        var asset = ZionBase.Asset.fromOperation(xdr);

        expect(asset).to.be.instanceof(ZionBase.Asset);
      ...
      it("parses a 4-alphanum asset XDR", function () {
        ...
        var assetCode = 'KHL';
        var assetType = new ZionBase.xdr.AssetAlphaNum4({
          assetCode: assetCode + '\0',
          issuer: ZionBase.Keypair.fromPublicKey(issuer).xdrAccountId()
        });
        var xdr = new ZionBase.xdr.Asset('assetTypeCreditAlphanum4', assetType);
      ...
      it("parses a 12-alphanum asset XDR", function () {
        ...
        var xdr = new ZionBase.xdr.Asset('assetTypeCreditAlphanum12', assetType);
