 ...
 * 
 * <p><strong>Be careful about unsubmitted transactions!</strong> When you build a transaction, zion-sdk
...
export class TransactionBuilder {
  ...
  /**
   * Because of the distributed nature of the Zion network it is possible that the status of your transaction
