...
export class Transaction {
   ...
   * - Use {@link Keypair} to generate a keypair object for your Zion seed.
   ...
   * const keypair = Keypair.fromSecret(myRainbowSeed);
   ...
   * validators on the Zion Network will accept.
   *
