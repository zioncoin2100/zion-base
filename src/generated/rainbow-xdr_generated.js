...
//
// ===========================================================================
xdr.enum("RainbowValueType", {
  rainbowValueBasic: 0,
  rainbowValueSigned: 1,
});
...
// === xdr source ============================================================
//
//   union switch (RainbowValueType v)
//       {
...
//
// ===========================================================================
xdr.union("RainbowValueExt", {
  switchOn: xdr.lookup("RainbowValueType"),
  switchName: "v",
  switches: [
    ["rainbowValueBasic", xdr.void()],
    ["rainbowValueSigned", "lcValueSignature"],
  ],
  arms: {
...
//       RainbowValue scpValue;   // what consensus agreed to
...
xdr.struct("LedgerHeader", [
  ...
  ["scpValue", xdr.lookup("RainbowValue")],
...
// === xdr source ============================================================
//
//   union RainbowMessage switch (MessageType type)
//   {
//   case ERROR_MSG:
//       Error error;
//   case HELLO:
...
xdr.struct("AuthenticatedMessageV0", [
  ...
  ["message", xdr.lookup("RainbowMessage")],
