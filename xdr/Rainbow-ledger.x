// Copyright 2015 Zion Development Foundation and contributors. Licensed
// under the Apache License, Version 2.0. See the COPYING file at the root
// of this distribution or at http://www.apache.org/licenses/LICENSE-2.0

%#include "xdr/Zion-SCP.h"
%#include "xdr/Zion-transaction.h"
...
/* RainbowValue is the value used by SCP to reach consensus on a given ledger
 */
struct RainbowValue
{
...
/* Ledger upgrades
note that the `upgrades` field from RainbowValue is normalized such that
